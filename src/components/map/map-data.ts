...
export const PARQUES: MapFeature[] = [
  ...
  { type: "parques", title: "Patagonia (Argentina)", coordinates: [-72.27, -47.57], pageUrl: "/parques/patagonia-sc", description: "El proyecto de rewilding más ambicioso de Argentina. Estepas, pumas y huemules en Santa Cruz.", properties: { País: "Argentina", Provincia: "Santa Cruz", Superficie: "467.533 ha" } },
  { type: "parques", title: "Bosques Petrificados de Jaramillo", coordinates: [-68.0, -47.78], pageUrl: "/parques/bosques-petrificados-de-jaramillo", description: "El bosque petrificado más grande del hemisferio sur: troncos de araucarias de 150 millones de años.", properties: { País: "Argentina", Provincia: "Santa Cruz", Superficie: "60.369 ha" } },
  { type: "parques", title: "Laguna Blanca", coordinates: [-70.33, -39.03], pageUrl: "/parques/laguna-blanca", description: "Humedal de estepa volcánica neuquina con colonia nidificante de flamencos australes.", properties: { País: "Argentina", Provincia: "Neuquén", Superficie: "11.250 ha" } },
  { type: "parques", title: "Alerce Andino", coordinates: [-72.5, -41.6], pageUrl: "/parques/alerce-andino", description: "Bosques de alerce patagónico de hasta 3.600 años de antigüedad en los fiordos de Los Lagos.", properties: { País: "Chile", Región: "Los Lagos", Superficie: "39.255 ha" } },
  { type: "parques", title: "Hornopirén", coordinates: [-72.43, -41.87], pageUrl: "/parques/hornopiren", description: "Volcanes activos, termas de Porcelana y bosques de alerce en el inicio de la Carretera Austral.", properties: { País: "Chile", Región: "Los Lagos", Superficie: "48.232 ha" } },
  { type: "parques", title: "Pumalín Douglas Tompkins", coordinates: [-72.65, -42.8], pageUrl: "/parques/pumalin-douglas-tompkins", description: "Legado Tompkins: 402.000 ha de selva valdiviana, alerces milenarios y el volcán Chaitén.", properties: { País: "Chile", Región: "Los Lagos", Superficie: "402.191 ha" } },
  { type: "parques", title: "Corcovado", coordinates: [-72.8, -43.55], pageUrl: "/parques/corcovado", description: "El golfo Corcovado concentra una de las mayores densidades de ballenas azules del planeta (Ene–Mar).", properties: { País: "Chile", Región: "Los Lagos", Superficie: "294.903 ha" } },
  { type: "parques", title: "Isla Magdalena", coordinates: [-72.85, -44.6], pageUrl: "/parques/isla-magdalena", description: "Fiordos y canales de Aysén con nutria de mar, lobos marinos y aves marinas endémicas.", properties: { País: "Chile", Región: "Aysén", Superficie: "157.616 ha" } },
  { type: "parques", title: "Laguna San Rafael", coordinates: [-73.9, -46.6], pageUrl: "/parques/laguna-san-rafael", description: "El glaciar San Rafael y el Campo de Hielo Norte: el glaciar de latitudes templadas más accesible del mundo.", properties: { País: "Chile", Región: "Aysén", Superficie: "1.742.000 ha" } },
  { type: "parques", title: "Cerro Castillo", coordinates: [-72.14, -46.11], pageUrl: "/parques/cerro-castillo", description: "Trekking de cuatro días entre basalto negro y glaciares colgantes, menos masificado que Torres del Paine.", properties: { País: "Chile", Región: "Aysén", Superficie: "179.550 ha" } },
  { type: "parques", title: "Patagonia (Chile)", coordinates: [-72.5, -47.5], pageUrl: "/parques/patagonia-cl", description: "Donación Tompkins: 300.000 ha de rewilding con huemules, pumas y guanacos en Valle Chacabuco.", properties: { País: "Chile", Región: "Aysén", Superficie: "301.920 ha" } },
  { type: "parques", title: "Kawésqar", coordinates: [-75.0, -51.5], pageUrl: "/parques/kawesqar", description: "El parque terrestre más grande de Chile: 7 millones de ha de canales, fiordos y patrimonio kawésqar.", properties: { País: "Chile", Región: "Magallanes", Superficie: "7.023.542 ha" } },
  { type: "parques", title: "Alberto de Agostini", coordinates: [-69.5, -54.4], pageUrl: "/parques/alberto-de-agostini", description: "Canal Beagle, Cordillera Darwin y glaciares que caen al mar en el extremo sur del continente.", properties: { País: "Chile", Región: "Magallanes", Superficie: "1.460.000 ha" } },
  { type: "parques", title: "Cabo de Hornos", coordinates: [-67.27, -55.97], pageUrl: "/parques/cabo-de-hornos", description: "El parque más austral de América. El Cabo de Hornos, reserva UNESCO, donde se unen el Pacífico y el Atlántico.", properties: { País: "Chile", Región: "Magallanes", Superficie: "63.093 ha" } },
];
